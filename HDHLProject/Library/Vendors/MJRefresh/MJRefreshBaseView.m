...
{
    if (!_arrowImage) {
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"public_loading5"]];
        //默认
//        arrowImage.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
//        [_imageView setImage:UIImageForName(@"public_loading5")];
        arrowImage.animationImages = @[UIImageForName(@"public_loading1"),UIImageForName(@"public_loading2"),UIImageForName(@"public_loading3"),UIImageForName(@"public_loading4")];
        [arrowImage setAnimationDuration:1];
...
- (BOOL)isRefreshing
{
    return MJRefreshStateRefreshing == self.state || MJRefreshStateWillRefreshing == _state;
}
...
//			self.arrowImage.hidden = YES;
            ...
            if ([self.beginRefreshingTaget respondsToSelector:self.beginRefreshingAction]) {
                ...
                [self.beginRefreshingTaget performSelector:self.beginRefreshingAction withObject:self afterDelay:0];
