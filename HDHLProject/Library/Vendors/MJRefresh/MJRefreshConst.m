...
NSString *const MJRefreshFooterPullToRefresh = @"上拉加载数据";
NSString *const MJRefreshFooterReleaseToRefresh = @"松开立即加载";
NSString *const MJRefreshFooterRefreshing = @"加载中...";

NSString *const MJRefreshHeaderPullToRefresh = @"下拉刷新数据";
